...
class GenieTool:
    ...
    def __init__(
        ...
        logger.info(f"GenieTool initialized with space_id: {self.space_id}")
...
def create_genie_tool() -> Tool:
    ...
    return Tool(
        ...
        description=(
            "데이터 분석 도구입니다. "
            "데이터베이스의 정보를 자연어로 질문하여 분석할 수 있습니다. "
            "판매 실적, 통계, 고객 정보 등을 조회할 때 사용합니다. "
            "입력: 분석하려는 내용을 자연어로 입력 (예: '지난달 판매 실적')"
        ),
        func=genie_tool.run,
